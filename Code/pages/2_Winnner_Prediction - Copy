...
pickle_in1 = open('K:\Sanket-datascience\CWC_prediction\Models\lr_model.pkl', 'rb')  
lr_model = pickle.load(pickle_in1)  
pickle_in2 = open('K:\Sanket-datascience\CWC_prediction\Models\svc_model.pkl', 'rb')  
svc_model = pickle.load(pickle_in2)  
pickle_in3 = open('K:\Sanket-datascience\CWC_prediction\Models\gbm_model.pkl', 'rb')  
gbm_model = pickle.load(pickle_in3)  
pickle_in4 = open('K:\\Sanket-datascience\\CWC_prediction\\Models\\rf_model.pkl', 'rb')  
...
# Load the datasets
winners_pvt_feat= pd.read_pickle('K:\\Sanket-datascience\\CWC_prediction\\Data\\prediction_related_data\\wc_winners.pkl')
winners_pvt_feat.drop('date',axis=1,inplace=True)
rup_pvt_feat= pd.read_pickle('K:\\Sanket-datascience\\CWC_prediction\\Data\\prediction_related_data\\wc_rups.pkl')
rup_pvt_feat.drop('date',axis=1,inplace=True)
team_feats_feat= pd.read_pickle('K:\\Sanket-datascience\\CWC_prediction\\Data\\prediction_related_data\\team_feats.pkl')
team_feats_feat.drop('date',axis=1,inplace=True)
head_to_head_feat= pd.read_pickle('K:\\Sanket-datascience\\CWC_prediction\\Data\\prediction_related_data\\head2head.pkl')
head_to_head_feat.drop('date',axis=1,inplace=True)
team_wins_in_cty= pd.read_pickle('K:\\Sanket-datascience\\CWC_prediction\\Data\\prediction_related_data\\win_pct_in_cty.pkl') 
team_wins_in_cty.drop('date',axis=1,inplace=True)
with open('K:\\Sanket-datascience\\CWC_prediction\\Data\\prediction_related_data\\top_teams.pkl', 'rb') as f:
    top_eight_teams_ls= pickle.load(f)
with open('K:\\Sanket-datascience\\CWC_prediction\\Data\\prediction_related_data\\wc_event.pkl', 'rb') as f:
    wc_event_ls= pickle.load(f)
with open('K:\\Sanket-datascience\\CWC_prediction\\Data\\prediction_related_data\\col_seq.pkl', 'rb') as f:
